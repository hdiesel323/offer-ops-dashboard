...
import { updateOffer, fetchOffer, fetchBuyers, type Offer, type Buyer } from '@/lib/supabase'
...
export default function EditOfferPage() {
  ...
  async function loadData() {
    try {
      setLoadingData(true)
      const [offerData, buyersData] = await Promise.all([
        fetchOffer(params.id as string),
        fetchBuyers()
      ])
      ...
      setFormData({
        ...
        campaign_name: offerData.campaign_name,
        vertical: offerData.vertical,
        status: offerData.status,
        offer_type: offerData.offer_type,
        direction: offerData.direction,
        buyer_id: offerData.buyer_id,
        publisher_payout_min: offerData.publisher_payout_min,
        publisher_payout_max: offerData.publisher_payout_max,
        advertiser_price_min: offerData.advertiser_price_min,
        advertiser_price_max: offerData.advertiser_price_max,
        states_allowed: offerData.states_allowed || [],
        age_range: offerData.age_range || '',
        hours_of_operation: offerData.hours_of_operation || '',
        compliance_requirements: offerData.compliance_requirements || '',
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await updateOffer(params.id as string, {
        ...formData,
      ...
      toast.current?.show({
        severity: 'error',
        summary: 'Error',
        detail: error.message || 'Failed to update offer',
        life: 5000
      })
    } finally {
      setLoading(false)
      ...
      <div className="container mx-auto py-8 max-w-4xl">
        <Card>
          <div className="text-center py-10">
            ...
            <p className="text-gray-600 mb-4">The offer you&apos;re trying to edit doesn&apos;t exist.</p>
  ...
  return (
    <div className="container mx-auto py-8 max-w-4xl">
      ...
      <div className="mb-6">
        ...
        <p className="text-gray-600">{formData.offer_id} - {formData.campaign_name}</p>
      </div>
          ...
          <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <InputText
                    ...
                    disabled
                  />
                  <small className="text-xs text-gray-500">Offer ID cannot be changed</small>
                </div>
            ...
            <div className="flex gap-3 justify-end pt-4 border-t">
              <Button
                ...
                severity="secondary"
                outlined
                onClick={() => router.push(`/offers/${params.id}`)}
                type="button"
              />
              <Button
                label="Save Changes"
